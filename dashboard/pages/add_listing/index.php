    ...
    <div class="py-12 px-24 sm:ml-64">
        ...
        <form action="" method="post" class="p-4" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <textarea id="deskripsi" name="deskripsi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"></textarea>
            </div>
            <div class="mb-6">
