                        ...
                        <?php foreach($transactions as $tran) : ?>
                            ...
                            <td class="px-6 py-4 font-medium text-base text-slate-500">
                                <?php if($tran["total_harga"] !== '0') : ?>
                                    <img src="./../../../public/img/<?= $tran['bukti_bayar'] ?>" alt="Image">
                                <?php else : ?>
                                    -
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="px-6 py-4 font-medium text-base text-slate-500">
                                <?php if($tran["status"] === 'pending') : ?>
                                    <a href="./approval/index.php?transaksi_id=<?= $tran["transaksi_id"] ?>" type="button" class="flex gap-x-2 items-center justify-center focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 ">Setujui Transaksi <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
