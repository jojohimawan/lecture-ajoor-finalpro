                ...
                <table class="w-full text-sm text-left text-slate-500">
                    ...
                    <tbody>
                        <?php foreach($transactions as $tran) : ?>
                            ...
                            <td class="px-6 py-4 font-medium text-base text-slate-500">
                                <img src="./../../../public/img/<?= $tran['foto'] ?>" class="w-80" alt="Image">
                            </td>
                            ...
                            <td class="px-6 py-4 font-medium text-base text-slate-500">
                                <?php if($tran["status"] === 'pending') : ?>
                                    -
                                <?php else : ?>
                                    <a href="./download/index.php?produk_id=<?= $tran["produk_id"] ?>&transaksi_id=<?= $tran['transaksi_id'] ?>" type="button" class="flex gap-x-2 items-center justify-center focus:outline-none text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 ">Download <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-4 h-4">
